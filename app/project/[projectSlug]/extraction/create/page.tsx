...
import CreateExtraction from "@/components/form/CreateExtraction";
...
export default async function Page({ params }: { params: { projectSlug: string } }) {
    ...
    return (
        <Container>
            <ContainerBreadCrumb>
                <Breadcrumb className="flex">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink asChild>
                                <Link href={`/project/${params.projectSlug}/extraction/create`}>Créer une extraction</Link>
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                    </BreadcrumbList>
            ...
            <ContainerForm>
                <CreateExtraction projectSlug={params.projectSlug} />
            </ContainerForm>
        </Container>
    )
